...
class TPM_Registration_Pipeline:
    ...
    def __init__(self):
        ...
        self.ref_tpm = '../data/mni_atlas_2mm.nii.gz' 
        self.gaussian_window_size = 5
        self.gaussian_sigma = 1
        self.classifier_model_file = '../models/dti_tissue_classifier.sav'
        self.classifier_stats_file = '../models/dti_statistics.p'
    ...
    def create_parser(self):      
        ...
        self.parser.add_argument("-i", "--input", type = str, metavar = 'FA_filename',
                            help = "filename of input FA map - must be in the same directory with Lambda maps", required = True)
        ...
        self.parser.add_argument("-ot", "--out_tpm", type = str, nargs = '?', default = None, const = 'default', metavar = 'TPM_savedir', 
        ...
        self.parser.add_argument("-sw", "--save_wrap", type = str, nargs = '?', default = None, const = 'default', metavar = 'warp_savedir',
    ...
    def parse_input(self, test_args = None):
        ...
        if args.save_wrap is None:
            ...
            self.save_warpfields = os.path.join(default_dirpath, '{}Warpfields{}.sav'.format(self.basename[0], self.basename[1]))
        else:
            self.save_warpfields = os.path.join(args.save_wrap, '{}Warpfields{}.sav'.format(self.basename[0], self.basename[1]))
